...
public struct AufklarerQwen3AsrCoreMLEvaluationSpec: RepositoryEvaluationSpec {
    public let repositoryId = "aufklarer/Qwen3-ASR-CoreML"
    public let supportedArtifacts: Set<String> = ["coreml"]
    ...
    public init(
        ...
        defaultMaxNewTokens: Int = 448,
        supportedFrameworks: Set<String> = ["speechswift"]
    ) {
    ...
    public func validate(_ result: EvaluationResult) throws {
        ...
        guard result.framework == "speechswift" else {
